...
class MediaGalleryPage extends Component {
    ...
    // We ensure action is dispatched to the store only if param is provided
    handleSearch(event) {
...
// Subscribe components props to redux store and merge the state into component's props
